...
export default function App() {
  ...
  const [fontloaded] = useFonts ({ //useFonts devuelve un array, el 1er elemento es boolean indicando si terminó la carga o nó
  ...
  if (gameIsOver && userNumber){
    screen = < GameOverScreen roundsNumber={guessRounds} userNumber={userNumber} onStarNewGame={starNweGameHandler}/>;
  }
